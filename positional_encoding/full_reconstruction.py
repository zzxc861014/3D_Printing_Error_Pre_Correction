...
def full_braces(folder_path='/work/310613060/two_stage/P_G_17_models/Calibrated/Post_Curing_Calibrated/_0017_G_Cal/'):
...
def main():
    ...
    model = torch.load('/work/310613060/two_stage/P_G_17_models/checkpoints_GD/generator_1500.pth')
    model.to(device)
    model.eval()
    threshold = 0.5
    ...
    for i in range(len(img)):
        ...
        im = im.convert('L')
        im.save('/work/310613060/two_stage/P_G_17_models/Calibrated/Post_Curing_Calibrated/_0017_/'+str(i).zfill(3)+'.png')
