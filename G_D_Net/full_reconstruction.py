...
def full_braces(folder_path='/work/310613060/two_stage/Cross_Validation_Dice/Master_thesis_image/P_G/_0017_/'):
...
def main():
    ...
    model = torch.load('/work/310613060/two_stage/Cross_Validation_Dice/G_D/checkpoints16-17/generator_1500.pth')
    model.to(device)
    model.eval()
    threshold = 0.5
    ...
    for i in range(len(img)):
        ...
        im = im.convert('L')
        im.save('/work/310613060/two_stage/Cross_Validation_Dice/Master_thesis_image/P_G_D/_0017_/'+str(i).zfill(3)+'.png')
