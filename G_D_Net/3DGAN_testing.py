...
def main():
    ...
    for model_name in files:
        model = torch.load('/work/310613060/two_stage/Cross_Validation_Dice/G_D/checkpoints4-6/generator_'+str(int(model_name))+'.pth')
        model.to(device)
        model.eval()
        threshold = 0.5
    ...
    plt.savefig('train_accuracy_4-6.png')
